...
from omni.isaac.lab.utils.math import compute_pose_error, quat_from_euler_xyz, quat_unique

if TYPE_CHECKING:
    from omni.isaac.lab.envs import ManagerBasedEnv
    from .world_pose_command_cfg import WorldPoseCommandCfg
...
class UniformWorldPoseCommand(CommandTerm):
    ...
    def _resample_command(self, env_ids: Sequence[int]):
        ...
        self.pose_command_w[env_ids, :2] += self.env.scene.env_origins[env_ids, :2]
