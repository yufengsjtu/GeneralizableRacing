...
from standalone.diff_rl.algorithms import AlgoRunner
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # create runner from diff-rl
    runner = AlgoRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
    ...
    # run training
    runner.learn(num_learning_iterations=agent_cfg.max_iterations, init_at_random_ep_len=agent_cfg.init_at_random_ep_len)
