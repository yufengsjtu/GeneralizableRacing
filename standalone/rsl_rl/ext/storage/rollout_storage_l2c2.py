...
class RolloutStorageL2C2:
    ...
    def __init__(self, training_type, num_envs, num_transitions_per_env, obs_shape, privileged_obs_shape, actions_shape, device='cpu'):
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_observations_batch, next_obs_batch, cont_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, \
